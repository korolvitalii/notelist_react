            ...
            <tr key={id}>
              ...
              <th scope="col" className="w-25 p-3 text-right">
                <i
                  ...
                  onClick={handleFormAddNewNote(id)}
                ></i>
                <i
                  className="p-1 bi bi-archive"
                  onClick={handleArchivateNote(note)}
                ></i>
                <i className="p-1 bi bi-trash" onClick={handleRemoveNote(note)}></i>
              </th>
            </tr>
          )
        })}
...
const ButtonAddNewTask = ({ handleAddTask, handleAddNewNote }) => {
  return (
    <button
      type="button"
      className="btn btn-outline-primary p-2 m-2 float-right"
